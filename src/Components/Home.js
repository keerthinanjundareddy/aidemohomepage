...
import sales from '../../src/Assets/Funding (4).png'
  ...
  import hivocologo from '../../src/Assets/Circular logo (1).png'
      ...
      <img  src={hivocologo} alt="hivocologo" className='navbar-image-two'/>
          ...
          {/* <div className='pricing-full-page-container' > */}
            <div className='card-container'>
                  ...
                  <div className='card' style={{backgroundColor:"#E2FDC7"}}  >
                    <div style={{width:"60px",height:"60px"}}>
                     <img src={sales} className='logo-xircular' style={{width:"100%",height:"100%",objectFit:"cover"}}/>
                     </div>
                    <div style={{ paddingTop: "30px", paddingBottom: "10px",letterSpacing:"0.5px",color:"#000000" }} className='items-title-div'><b>SALES-AGENT</b></div>
                       <div style={{paddingTop:"10px", className:"item-dec-div",color:"#1F1F1F"}} className='items-title-description'>To boost revenue and efficiency in your products, we implement a Virtual Sales Agent. It relies on product data and customer profiles, enabling personalized service recommendations and easy appointment scheduling. Imagine a digital assistant that guides customers and increases product sales.</div> 
                       <div style={{paddingTop:"20px",color:"#1F1F1F"}} className='how-it-works-section'onClick={() => popupeditsales()}><span  className='how-it-works-section-two' style={{color:"#1F1F1F"}}></span>READ MORE</div>
                 
                  </div>

                  <div className='card' style={{backgroundColor:"#0B303B"}}  >
                    <div style={{width:"60px",height:"60px"}}>
                     <img src={documentqa} className='logo-xircular' style={{width:"100%",height:"100%",objectFit:"cover"}}/>
                     </div>
                    <div style={{ paddingTop: "30px", paddingBottom: "10px",letterSpacing:"0.5px",color:"#FFFFFF" }} className='items-title-div'><b>DOCUMENT-QA</b></div>
                       <div style={{paddingTop:"10px",color:"#F2F2F2", className:"item-dec-div"}} className='items-title-description'>Our Document-Based AI Chatbot simplifies access to company information. It's powered by company documents and data sources, providing instant responses to natural language queries. This means employees can effortlessly retrieve policies and documents, making information readily accessible.</div> 
                       <div style={{paddingTop:"20px",color:"#F2F2F2"}} className='how-it-works-section' onClick={() => popupeditdocument()}><span  className='how-it-works-section-two' style={{color:"#F2F2F2"}}></span>READ MORE</div>
                 
                  </div>
                
                  <div className='card' style={{backgroundColor:"#5454D2"}} >
                    <div style={{width:"60px",height:"60px"}}>
                     <img src={Employee} className='logo-xircular' style={{width:"100%",height:"100%",objectFit:"cover"}}/>
                     </div>
                    <div style={{ paddingTop: "30px", paddingBottom: "10px",letterSpacing:"0.5px",color:"#FFFFFF" }} className='items-title-div'><b>EMPLOYEE-DASHBOARD</b></div>
                       <div style={{paddingTop:"10px", color:"#F2F2F2",className:"item-dec-div"}} className='items-title-description'>To simplify performance reporting, our Employee Work Summary Chatbot employs employee performance data and reporting tools. Picture a chatbot that engages with your HR system, effortlessly generating graphical work summaries and performance insights, making management more data-driven and efficient.</div> 
                       <div style={{paddingTop:"20px",color:"#F2F2F2"}} className='how-it-works-section' onClick={() => popupeditemployee()}><span  className='how-it-works-section-two'></span>READ MORE</div>
                 
                  </div>
                
                  <div className='card'  style={{backgroundColor:"#D0EAE6"}} >
                    <div style={{width:"60px",height:"60px"}}>
                     <img src={voice} className='logo-xircular' style={{width:"100%",height:"100%",objectFit:"cover"}}/>
                     </div>
                    <div style={{ paddingTop: "30px", paddingBottom: "10px",letterSpacing:"0.5px",color:"#000000" }} className='items-title-div'><b>VOICE-CLONING</b></div>
                       <div style={{paddingTop:"10px", color:"#1F1F1F" ,className:"item-dec-div"}} className='items-title-description'>In the realm of entertainment and marketing, we introduce Voice Cloning into Celebrity Voices. With high-quality audio samples of your chosen celebrity, you can transform your voice, opening up creative possibilities for advertisements, content creation, and more. Imagine speaking in the voice of your favorite celebrity!</div> 
                       <div style={{paddingTop:"20px",color:"#1F1F1F"}} className='how-it-works-section'  onClick={() => popupeditvoice()}><span  className='how-it-works-section-two'></span>READ MORE</div>
                 
                  </div>
                

                  <div className='card'  style={{backgroundColor:"#FCD3CA"}}  >
                    <div style={{width:"60px",height:"60px"}}>
                     <img src={facerecog} className='logo-xircular' style={{width:"100%",height:"100%",objectFit:"cover"}}/>
                     </div>
                    <div style={{ paddingTop: "30px", paddingBottom: "10px",letterSpacing:"0.5px", color:"#000000"}} className='items-title-div'><b>FACE-RECOGNITION</b></div>
                       <div style={{paddingTop:"10px",color:"#1F1F1F", className:"item-dec-div"}} className='items-title-description'>Enhance security and convenience with Face Recognition Technology. By utilizing a database of facial images, we accurately identify individuals based on their unique features. This technology streamlines access control, ensuring only authorized individuals gain entry, making facilities safer and more efficient.</div> 
                       <div style={{paddingTop:"20px",color:"#1F1F1F"}} className='how-it-works-section' onClick={() => popupeditface()}><span  className='how-it-works-section-two'></span>READ MORE</div>
                 
                  </div>
                

                  <div className='card'  style={{backgroundColor:"#887D8A"}}  >
                    <div style={{width:"60px",height:"60px"}}>
                     <img src={sentiment} className='logo-xircular' style={{width:"100%",height:"100%",objectFit:"cover"}}/>
                     </div>
                    <div style={{ paddingTop: "30px", paddingBottom: "10px",letterSpacing:"0.5px",color:"#FFFFFF" }} className='items-title-div'><b>SENTIMENTAL-ANALYSIS</b></div>
                       <div style={{paddingTop:"10px",color:"#F2F2F2" ,className:"item-dec-div"}} className='items-title-description'>Understand your customers better with Sentiment Analysis for Customer Reviews. This technology leverages access to customer reviews and feedback, allowing you to gain valuable insights into customer sentiment. Make informed decisions and improve customer satisfaction based on real-time feedback.</div> 
                       <div style={{paddingTop:"20px",color:"#F2F2F2"}} className='how-it-works-section' onClick={() => popupeditsentiment()}><span  className='how-it-works-section-two' ></span>READ MORE</div>
